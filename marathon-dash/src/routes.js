...
const Tutorials = React.lazy(() => import('./views/tutorial/Tutorials'))
const Blogs = React.lazy(() => import('./views/blog/Blogs'))
const testBoard = React.lazy(() => import('./views/testBoard/testBoard'))
...
//Forms
const AddCampaign = React.lazy(() => import('./views/forms/add-campaign/AddCampaign'))
...
const routes = [
  ...
  { path: '/testBoard', name: 'Test Board', element: testBoard },  
